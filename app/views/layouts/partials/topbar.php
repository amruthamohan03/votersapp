        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="dropdown">
                <button class="topbar-link" data-bs-toggle="dropdown" type="button">
                    <img src="<?php echo BASE_URL; ?>/assets/images/flags/<?php echo ($_SESSION['lang'] ?? 'en') === 'fr' ? 'fr' : 'us'; ?>.svg"
                        alt="flag" class="w-100 rounded" height="14">
                </button>

                <div class="dropdown-menu dropdown-menu-end">
                    <a href="<?= BASE_URL ?>/language/switch/fr" class="dropdown-item">
                <img src="<?= BASE_URL ?>/assets/images/flags/fr.svg" height="14" class="me-1 rounded">
                <span>French</span>
            </a>

            <a href="<?= BASE_URL ?>/language/switch/en" class="dropdown-item">
                <img src="<?= BASE_URL ?>/assets/images/flags/us.svg" height="14" class="me-1 rounded">
                <span>English</span>
            </a>
                    ...
                    <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                        ...
                        <div class="position-relative rounded-0" style="max-height: 300px;" data-simplebar>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap active" id="notification-1">
                                <span class="d-flex align-items-center">
                                    <span class="me-3 position-relative flex-shrink-0">
                                        <img src="<?php echo BASE_URL; ?>/assets/images/users/avatar-2.jpg" class="avatar-lg rounded-circle"
                                            alt="" />
                                    </span>
                                    <span class="flex-grow-1 text-muted">
                                        <span class="fw-medium text-body">Glady Haid</span> commented on <span
                                            class="fw-medium text-body">Malabar Status</span>
                                        <br />
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-2">
                                <span class="d-flex align-items-center">
                                    <span class="me-3 position-relative flex-shrink-0">
                                        <img src="<?php echo BASE_URL; ?>/assets/images/users/avatar-4.jpg" class="avatar-lg rounded-circle"
                                            alt="" />
                                    </span>
                                    <span class="flex-grow-1 text-muted">
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-4">
                                <span class="d-flex align-items-center">
                                    <span class="me-3 position-relative flex-shrink-0">
                                        <img src="<?php echo BASE_URL; ?>/assets/images/users/avatar-7.jpg" class="avatar-lg rounded-circle"
                                            alt="" />
                                    </span>
                                    <span class="flex-grow-1 text-muted">
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-5">
                                <span class="d-flex align-items-center">
                                    <span class="me-3 position-relative flex-shrink-0">
                                        <img src="<?php echo BASE_URL; ?>/assets/images/users/avatar-10.jpg" class="avatar-lg rounded-circle"
                                            alt="" />
                                    </span>
                                    <span class="flex-grow-1 text-muted">
            ...
            <div class="topbar-item nav-user">
                <div class="dropdown">
                    <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown"
                        ...
                        <!-- <img src="<?php echo BASE_URL; ?>/assets/images/users/avatar-1.jpg" width="32" class="rounded-circle me-lg-2 d-flex"
                            alt="user-image"> -->
                            <img src="<?php echo !empty($_SESSION['user_data']['profile_image']) 
                                        ? BASE_URL . '/uploads/profiles/' . $_SESSION['user_data']['profile_image'] 
                                        : BASE_URL . '/assets/images/users/avatar-1.jpg'; ?>" 
                                width="32" 
                                class="rounded-circle me-lg-2 d-flex"
                                alt="<?php echo htmlspecialchars($_SESSION['user_data']['fullname']); ?>">
                        <span class="d-lg-flex flex-column gap-1 d-none">
                            <h5 class="my-0">
                                <?php echo !empty($_SESSION['user_data']['fullname']) 
                                    ? htmlspecialchars($_SESSION['user_data']['fullname']).' ['.htmlspecialchars($_SESSION['user_data']['role_name']) .']'
                                    : 'User'; ?>
                            </h5>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="<?php echo APP_URL;?>account/index" class="dropdown-item">
                        ...
                        <!-- item-->
                        <a href="<?php echo APP_URL;?>auth/logout" class="dropdown-item active fw-semibold text-danger">
...
<input type="hidden" value="<?php echo APP_URL; ?>" name="app_url" id="app_url"/>
